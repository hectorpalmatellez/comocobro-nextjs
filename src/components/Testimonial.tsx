export default function Testimonial() {
    return (<section id="testimonial" className="padding-medium position-relative">
        ...
        <div className="container">
            <div className="offset-md-2 col-md-8 ">
                <div
                    className="swiper testimonial-swiper py-3 py-md-5 swiper-initialized swiper-horizontal swiper-backface-hidden">
                            ...
                            <div className="review">
                                <div className="review-content d-lg-flex">
                                    ...
                                    <div>
                                        ...
                                        <p className="fw-bold">John Geoffrey <span className="fw-normal">| Hexagon Builders inc., USA</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div
                        className="swiper-pagination pt-5 swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
                        ...
                        aria-label="Go to slide 2"></span><span className="swiper-pagination-bullet" tabIndex={0}
